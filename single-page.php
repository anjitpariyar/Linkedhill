				...
				<aside class="col-lg-9 pl-0">
					<div class="card">
						...
						<div class="slider-for">
							<!-- not more than 4 -->
							<div class="item">
								<a class="image" data-fancybox="gallery" href="./gallery/card__img/img08.png">
									<img src="./gallery/card__img/img08.png" alt="">
								</a>
							</div>
							<div class="item">
								<a class="image" data-fancybox="gallery" href="./gallery/card__img/img01.png">
									<img src="./gallery/card__img/img01.png" alt="">
								</a>
							</div>
							<div class="item">
								<a  class="image" data-fancybox="gallery" href="./gallery/card__img/img02.png">
						...
						<div class="card__body">
							<div class="d-flex">
								<p>322 Views</p>
								<p><span class="material-icons material-icons-outlined">location_on</span>Banepa, Nepal</p>
								<p>Last Updated: 8 May 2020</p>
								<div class="ml-0 mt-2 mt-md-0 ml-md-auto">
									<a href="#" title="print"><svg xmlns="http://www.w3.org/2000/svg" width="23.97" height="22.3" viewBox="0 0 23.97 22.3">
										<g id="interface" transform="translate(0.15 -17.915)">
											<g id="Group_877" data-name="Group 877" transform="translate(0 18.065)">
												<g id="Group_876" data-name="Group 876">
													<path id="Path_156" data-name="Path 156" d="M21.829,23.421h-2.51V18.854a.789.789,0,0,0-.789-.789H5.141a.789.789,0,0,0-.789.789v4.566H1.841A1.843,1.843,0,0,0,0,25.262V33.2a1.843,1.843,0,0,0,1.841,1.841H4.352v4.235a.789.789,0,0,0,.789.789H18.53a.789.789,0,0,0,.789-.789V35.041h2.511A1.843,1.843,0,0,0,23.67,33.2V25.262A1.843,1.843,0,0,0,21.829,23.421ZM5.93,19.643H17.741v3.777H5.93ZM17.741,38.487H5.93V32.032H17.741C17.741,32.227,17.741,38.339,17.741,38.487ZM22.092,33.2a.263.263,0,0,1-.263.263H19.319v-2.22a.789.789,0,0,0-.789-.789H5.141a.789.789,0,0,0-.789.789v2.22H1.841a.263.263,0,0,1-.263-.263V25.262A.263.263,0,0,1,1.841,25H21.829a.263.263,0,0,1,.263.263V33.2Z" transform="translate(0 -18.065)" fill="#3f8809" stroke="#fff" stroke-width="0.3"/>
												</g>
											</g>
											<g id="Group_879" data-name="Group 879" transform="translate(15.732 26.476)">
												<g id="Group_878" data-name="Group 878" transform="translate(0 0)">
													<path id="Path_157" data-name="Path 157" d="M343.1,199.988h-2.008a.789.789,0,1,0,0,1.578H343.1a.789.789,0,1,0,0-1.578Z" transform="translate(-340.298 -199.988)" fill="#3f8809" stroke="#fff" stroke-width="0.3"/>
												</g>
											</g>
											<g id="Group_881" data-name="Group 881" transform="translate(7.627 35.715)">
												<g id="Group_880" data-name="Group 880" transform="translate(0 0)">
													<path id="Path_158" data-name="Path 158" d="M172.6,399.834h-6.838a.789.789,0,1,0,0,1.578H172.6a.789.789,0,0,0,0-1.578Z" transform="translate(-164.977 -399.834)" fill="#3f8809" stroke="#fff" stroke-width="0.3"/>
												</g>
											</g>
											<g id="Group_883" data-name="Group 883" transform="translate(7.627 33.226)">
												<g id="Group_882" data-name="Group 882">
													<path id="Path_159" data-name="Path 159" d="M172.6,346.006h-6.838a.789.789,0,1,0,0,1.578H172.6a.789.789,0,0,0,0-1.578Z" transform="translate(-164.977 -346.006)" fill="#3f8809" stroke="#fff" stroke-width="0.3"/>
												</g>
											</g>
										</g>
									</svg></a>
									<a href="#" title="share">
										<svg xmlns="http://www.w3.org/2000/svg" width="19.334" height="19.334" viewBox="0 0 19.334 19.334">
											<path id="network" d="M15.191,11.048a4.129,4.129,0,0,0-3.333,1.7l-3.77-1.886a4.087,4.087,0,0,0,.2-1.2,4.087,4.087,0,0,0-.2-1.2l3.77-1.886a4.126,4.126,0,1,0-.81-2.438,4.086,4.086,0,0,0,.2,1.2L7.476,7.229a4.143,4.143,0,1,0,0,4.876l3.77,1.886a4.086,4.086,0,0,0-.2,1.2,4.143,4.143,0,1,0,4.143-4.143Zm0-9.667a2.762,2.762,0,1,1-2.762,2.762A2.765,2.765,0,0,1,15.191,1.381ZM4.143,12.429A2.762,2.762,0,1,1,6.9,9.667a2.765,2.765,0,0,1-2.762,2.762Zm11.048,5.524a2.762,2.762,0,1,1,2.762-2.762A2.765,2.765,0,0,1,15.191,17.953Z" transform="translate(0)" fill="#3f8809"/>
										</svg>
										<span>Share</span> 
							...
							<hr>
							<h2 class="card__title">Century Estate, Unit 2, 476 Gardeners Road,
							Alexandria, NSW 2015</h2>
							...
							<div class="d-flex">
								<p>
									<a href="#" class="star m-0"><span class="material-icons">grade</span><span class="material-icons">grade</span><span class="material-icons">grade</span><span class="material-icons">grade</span><span class="material-icons material-icons-outlined">grade</span> (123 Reviews) </a></p>
									...
									</svg> Property type:<label class="mb-0">input Office Space</label>
								</p>
								<p>Property ID: 503487066</p>
							</div>

							<p>Warehouse, Factory & Industrial • Showrooms & Bulky Goods</p>
							<div class="para">
							...
							<div class="card__action d-flex">
								...
								<div>
									...
									<p><span>Bathroom </span> <br> 3 Baths</p>
								...
								<div>
									...
									<p><span>Bathroom </span> <br> 4 Area</p>
								...
								<div>
									...
									</svg></label><p><span>Bathroom </span> <br> 2 Parking</p>
					...
					<div class="location">
						...
						<article class="map">
							<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d56516.31625950566!2d85.29111328652364!3d27.708955944420293!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb198a307baabf%3A0xb5137c1bf18db1ea!2sKathmandu%2044600!5e0!3m2!1sen!2snp!4v1595859064084!5m2!1sen!2snp" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
						</article>
					</div>
				...
				<aside  class="col-lg-3 p-0">
					<div class="sticky">
						<div class="card profile text-center">
							...
							<div class="card__body">
								<h2 class="card__title name">Johan matthew</h2>
								<span class="tags">Verified</span>
								<img src="./gallery/light_logo.png" alt="">
								<h2 class="card__title">Linkedhill International Center Pvt. Ltd</h2>
								<h2 class="small__title mb-0">16 Chabahil, 446600, Nepal</h2>
								<h2 class="small__title">License Number: 654321</h2>
								<a href="tel:9825131071" class="call btn">Call Agent</a>
								<a href="mailto:linkedhill@gmail.com" class="mail btn">Email Agent</a>
						...
						<div class="card profile search">
							<ul>
								...
								<li class="small__title"><a href="./category-page.php">Coworking spaces</a></li>
								<li class="small__title"><a href="./category-page.php">Commercial Real Estate</a></li>

								<li class="small__title"><a href="./category-page.php">Serviced Offices</a></li>
								<li class="small__title"><a href="./category-page.php">Sublet Office Spaces</a></li>
								<li class="small__title"><a href="./category-page.php">Workshop and Industrial Units</a></li>
								<li class="small__title"><a href="./category-page.php">Virtual Office</a></li>
	...
	<section class="feature nearby" >
		<div class="section-rule pt-0">
			<div class="section__title--wrapper">
				<h2 class="section__title">Nearby Office</h2>
			...
			<div class="carousel">
				<article class="item">
					<a class="card" href="./single-page.php">
						...
						<div class="card__body">
							<h2 class="card__title">Level 1, 63 Stead Street, South 
							Melbourne, VIC 3205</h2>
							<p class="small__title">16 Chabahil, 446600, Nepal</p>
	...
	<section class="feature recommended">
		<div class="section-rule pt-0">
			<div class="section__title--wrapper">
				...
				<a href="./category-page.php" class="section__link"><svg xmlns="http://www.w3.org/2000/svg" width="14.727" height="14.727" viewBox="0 0 14.727 14.727">
					<path id="Union_6" data-name="Union 6" d="M.127,10.749V2.379L0,2.389.127.8,10.079,0,9.951,1.592l-8.232.66v8.5Z" transform="translate(14.727 7.6) rotate(135)" fill="#313131" opacity="0.8"/>
				</svg>View More</a>
			</div>
