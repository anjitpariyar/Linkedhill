...
<main class="home-page">
	<section class="screen">
		<div class="carousel">
			<div class="item">
				<img src="./gallery/interior.png" alt="">
			</div>
			<div class="item">
				<img src="./gallery/interior01.jpg" alt="">
			</div>
			<div class="item">
				<img src="./gallery/interior02.jpg" alt="">
			</div>
		</div>
		<div class="absolute__wrapper">
			<div class="section-rule">
				<h2 class="screen__title">Find your <br> Dream Home</h2>
				<form class="form-inline main-form" action="./category-page.php" autocomplete="off">
					<aside>
		...
		<div class="section-rule">
			...
			<div class="row">
				<article class="col-sm-6">
					<div class="card">
						<div class="card__img">
							<img src="./gallery/card__img/img03.png" alt="card__title">
						</div>
						<div class="card__body">
						...
						<div class="card__body hover">
							<h2 class="card__title">New York</h2>
							<h2 class="small__title">Property By City</h2>
							<button onclick="window.location.href='./category-page.php'">View Details</button>
						</div>
				...
				<article class="col-sm-6">
					<div class="card">
						<div class="card__img">
							<img src="./gallery/card__img/img02.png" alt="card__title">
						</div>
						<div class="card__body">
							<h2 class="card__title">Chicago</h2>
							<div class="card__action d-flex">
								<h2 class="small__title">Property By City</h2>
								<h2 class="small__title">06 Properties</h2>
							</div>
						</div>
						<div class="card__body hover">
							<h2 class="card__title">Chicago</h2>
				...
				<article class="col-sm-6">
					<div class="card">
						...
						<div class="card__body">
							...
							<div class="card__action d-flex">
								<h2 class="small__title">Property By City</h2>
								<h2 class="small__title">08 Properties</h2>
							</div>
						</div>
						<div class="card__body hover">
							<h2 class="card__title">Chicago</h2>
	...
	<section class="feature listed cmm" >
		<div class="section-rule pb-0">
			<div class="section__title--wrapper">
				<h2 class="section__title">Listed Properties</h2>
				<a href="./category-page.php" class="section__link"><svg xmlns="http://www.w3.org/2000/svg" width="14.727" height="14.727" viewBox="0 0 14.727 14.727">
					<path id="Union_6" data-name="Union 6" d="M.127,10.749V2.379L0,2.389.127.8,10.079,0,9.951,1.592l-8.232.66v8.5Z" transform="translate(14.727 7.6) rotate(135)" fill="#313131" opacity="0.8"/>
				</svg>View More</a>
			</div>
	...
	<section class="nepal">
		<div class="section-rule">
			...
			<h2 class="section__title"><!-- Properties in Nepal to Buy or Rent --> Premium Properties in Nepal</h2>
			<div class="carousel">
				<div class="item">
					<a href="./category-page.php" class="card">
						<div class="card__img"><img src="./gallery/card__img/img07.png" alt=""></div>
						<div class="card__body">
				...
				<div class="item">
					<a href="./category-page.php" class="card">
						<div class="card__img"><img src="./gallery/card__img/img08.png" alt=""></div>
						<div class="card__body">
							<h2 class="card__title">Land</h2>
						</div>
					</a>
				</div>
				<div class="item">
					<a href="./category-page.php" class="card">
						<div class="card__img"><img src="./gallery/card__img/img01.png" alt=""></div>
						<div class="card__body">
							<h2 class="card__title">Appartment</h2>
						</div>
					</a>
				</div>
				<div class="item">
			...
			<div class="row">
				<article class="col-md-4">
					<div class="card">
						...
						<div class="card__body">
							<h2 class="small__title">22 Nov, 2019</h2>
							<h2 class="card__title"><a href="#">The 5 Biggest Mistake Veteran and Military Home Buyers Made</a></h2>
							<p class="para">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dignissimos molestias sequi repudiandae cupiditate nemo placeat, omnis. Maiores est, repellendus suscipit.</p>
							<a href="#" class="card__link" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="14.727" height="14.727" viewBox="0 0 14.727 14.727">
	...
	<div class="category-page search-page">
		...
		<script type="text/javascript" src="./node_modules/multiselect-master/multiselect.min.js"></script>
		<?php
		include 'footer.php';
		?>
		<!-- custom -->
