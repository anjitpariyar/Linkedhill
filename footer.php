	...
	<div class="section-rule">
		<div class="row">
			<article class="col-6 col-sm-4">
				<div class="logo">
					<img src="./gallery/logo02.png" alt="">
				</div>
				...
				<p class="link"><a href="mailto:info@linkedhill.com">info@linkedhill.com</a></p>	
			</article>
		...
		<div class="d-flex last__footer">
			<p>Copyright &copy; 2019 Linkedhill, All Rights Reserved.</p>
			<div class="d-flex">
			...
			<div class="row">
				...
				<div class="col-lg-6 wrapper">
					...
					<div class="modal-body">
						...
						<p class="mb-0 para">Don't have a account? <a href="./signup.php" class="link">Create account</a>.</p>
